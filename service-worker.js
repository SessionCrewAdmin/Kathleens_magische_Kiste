const CACHE='kathleen-v68-quickgames-todos-20260923';
const CORE=['./tools/quest-mode/index.html','./tools/quest-mode/quest.js','./tools/quest-mode/quest.css','./tools/quest-mode/landscape.webp','./tools/mobile-observations/index.html','./tools/seating-plan/mobile-view.js','./mobile-teacher-v34.js',
  ...
  './tools/english-world-quiz/index.html','./tools/english-world-quiz/bonus.html','./tools/quick-games/index.html','./tools/todos/index.html','./tools/homework-vouchers/index.html','./tools/escape-room/index.html','./tools/teacher-command/index.html',
...
async function decorateTeacherPage(url,res){
  ...
  const baseDesign=new URL('tools/teacher-design-v50.css?v=20260923-v68',scope).href;
  const adapter=new URL('tools/teacher-page-adapters-v50.css?v=20260923-v68',scope).href;
  const premium=new URL('tools/teacher-premium-pages-v57.css?v=20260923-v68',scope).href;
  const shell=new URL('tools/teacher-shell.js?v=20260923-v68',scope).href;
  const quickGames=new URL('tools/quick-games-integration.js?v=20260923-v68',scope).href;
  const todoPage=new URL('tools/todo-page-integration.js?v=20260923-v68',scope).href;
  let head='';
