const CACHE='kathleen-v52-premium-all-pages-20260923';
...
async function decorateTeacherPage(url,res){
  ...
  const baseDesign=new URL('tools/teacher-design-v50.css?v=20260923-premium2',scope).href;
  const adapter=new URL('tools/teacher-page-adapters-v50.css?v=20260923-premium2',scope).href;
