const CACHE='kathleen-v73-history-knowledge-base-20260923';
const CORE=['./tools/quest-mode/index.html','./tools/quest-mode/quest.js','./tools/quest-mode/quest.css','./tools/quest-mode/landscape.webp','./tools/mobile-observations/index.html','./tools/seating-plan/mobile-view.js','./mobile-teacher-v34.js',
  ...
  './data/history/schema-v1.json','./data/history/catalog.json','./data/history/grade-7/chapter-1.json',
...
async function decorateTeacherPage(url,res){
  ...
  const baseDesign=new URL('tools/teacher-design-v50.css?v=20260923-v73',scope).href;
  const adapter=new URL('tools/teacher-page-adapters-v50.css?v=20260923-v73',scope).href;
  const premium=new URL('tools/teacher-premium-pages-v57.css?v=20260923-v73',scope).href;
  const shell=new URL('tools/teacher-shell.js?v=20260923-v73',scope).href;
  const quickGames=new URL('tools/quick-games-integration.js?v=20260923-v73',scope).href;
  const premiumGames=new URL('tools/country-hunt-integration.js?v=20260923-v73',scope).href;
  const historyCenter=new URL('tools/history-content-center-integration.js?v=20260923-v73',scope).href;
  const todoPage=new URL('tools/todo-page-integration.js?v=20260923-v73',scope).href;
  let head='';
