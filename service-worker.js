const CACHE='kathleen-v87-vocabulary-navigation-20260924';
const CORE=['./tools/quest-mode/index.html','./tools/quest-mode/quest.js','./tools/quest-mode/quest.css','./tools/quest-mode/landscape.webp','./tools/mobile-observations/index.html','./tools/seating-plan/mobile-view.js','./mobile-teacher-v34.js',
  ...
  './tools/vocabulary/index.html','./tools/vocabulary/vocabulary.css','./tools/vocabulary/vocabulary.js','./tools/vocabulary-football/index.html','./tools/vocabulary-football/football.css','./tools/vocabulary-football/football.js','./data/vocabulary/schema-v1.json','./data/vocabulary/catalog.json','./data/vocabulary/audit.json','./data/vocabulary/grade-7/unit-1.json','./data/vocabulary/grade-7/unit-2.json','./data/vocabulary/grade-7/unit-3.json','./data/vocabulary/grade-7/unit-4.json','./data/vocabulary/grade-7/knowledge-boxes.json','./data/vocabulary/grade-9/supplements.json','./data/vocabulary/grade-9/unit-1.json','./data/vocabulary/grade-9/unit-2.json','./data/vocabulary/grade-9/unit-3.json','./data/vocabulary/grade-9/knowledge-boxes.json',
...
const TEACHER_EXCLUDE=/(\/student(?:\.html|\/)|\/present\.html|gamification-(?:student|beamer|remote)|\/vocabulary(?:-football)?\/)/i;
