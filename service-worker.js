const CACHE='kathleen-v62-core-dynamic-greeting-20260923';
...
async function decorateTeacherPage(url,res){
  ...
  const baseDesign=new URL('tools/teacher-design-v50.css?v=20260923-v62',scope).href;
  const adapter=new URL('tools/teacher-page-adapters-v50.css?v=20260923-v62',scope).href;
  const premium=new URL('tools/teacher-premium-pages-v57.css?v=20260923-v62',scope).href;
  const shell=new URL('tools/teacher-shell.js?v=20260923-v62',scope).href;
  let head='';
