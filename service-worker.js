const CACHE='kathleen-v58-premium-pages-session-20260923';
...
async function decorateTeacherPage(url,res){
  ...
  const baseDesign=new URL('tools/teacher-design-v50.css?v=20260923-v58',scope).href;
  const adapter=new URL('tools/teacher-page-adapters-v50.css?v=20260923-v58',scope).href;
  const shell=new URL('tools/teacher-shell.js?v=20260923-v58',scope).href;
  let head='';
