const CACHE='kathleen-v74-history-full-import-20260923';
...
async function decorateTeacherPage(url,res){
  ...
  const baseDesign=new URL('tools/teacher-design-v50.css?v=20260923-v74',scope).href;
  const adapter=new URL('tools/teacher-page-adapters-v50.css?v=20260923-v74',scope).href;
  const premium=new URL('tools/teacher-premium-pages-v57.css?v=20260923-v74',scope).href;
  const shell=new URL('tools/teacher-shell.js?v=20260923-v74',scope).href;
  const quickGames=new URL('tools/quick-games-integration.js?v=20260923-v74',scope).href;
  const premiumGames=new URL('tools/country-hunt-integration.js?v=20260923-v74',scope).href;
  const historyCenter=new URL('tools/history-content-center-integration.js?v=20260923-v74',scope).href;
  const todoPage=new URL('tools/todo-page-integration.js?v=20260923-v74',scope).href;
  let head='';
